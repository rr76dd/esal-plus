...
// طباعة جزء من المفتاح للتأكد من قراءته (دون كشف المفتاح كاملاً)
...
// إرسال بريد إلكتروني يحتوي على رمز OTP باستخدام Resend
...
// إرسال بريد إلكتروني تذكير بالدفع
